...
export const content = {
  ...
  cs: {
    ...
    hero: {
      ...
      claim2: 'šitý na míru.',
      sub: 'Něco si pustíš hned. Něco ti postavím na míru.',
      intro: 'Jsem Antonín Kindl. Dělám malý software na míru, vždy jedné úloze a jednomu člověku, vedle umělecké praxe na kindl.work. Něco si otevřeš rovnou v prohlížeči, nebo mi řekni, jaký nástroj ti chybí, a já ho udělám.',
      meta: ['na míru jedné úloze', 'běží v prohlížeči', 'bez účtu'],
    },
    how: {
      h: 'Nástroj přesně na tvou úlohu.',
      p1: 'Velký software se dělá pro všechny, takže nikomu nesedne přesně. Svůj týden ohýbáš podle jeho nabídek. Malý nástroj na jednu úlohu to má obráceně: sedne na to, jak už pracuješ, a tu opakující se část udělá za tebe.',
      p2: 'Většina nástrojů běží rovnou v prohlížeči, zdarma. Pokud nástroj, který potřebuješ, ještě neexistuje, je to obvykle práce na chvíli. Řekni mi úlohu a jak vypadají tvoje data; nástroj postavím kolem nich, ve tvém stylu, a předám ti ho. Umělecké studio na kindl.work staví vnímavé stroje: počítačové vidění, projekci, kinetiku, generativní grafiku. Software tady vzniká ve stejném studiu.',
      barLabel: 'jedna šablona',
      hintFine: 'přejeď přes ni →',
      hintCoarse: 'táhni přes ni →',
      cap: 'Jedna šablona a každá verze práce hned na místě. To pro tebe generátor dělá: opakování okamžitě a vždy v rámci stylu.',
    },
    bench: {
      h: 'Co vzniká na ponku.',
      intro: 'Čtyři linie, vybrané tam, kde se ukazuje náskok studia a kde jsou reálné rozpočty. Katalog roste; tohle je jeho pracovní tvář.',
      lines: [
    ...
    band: { line1: 'Na míru,', line2: 'jeden nástroj po druhém.', sub: 'Žádná platforma, žádné předplatné, žádný účet. Soubor, který otevřeš, nebo nástroj, který ti postavím a předám.' },
    ships: {
      h: 'Co vyjde jako první.',
      items: [
        { no: '01', nm: 'Generátor identity', what: 'Tvůj hotový vizuál, předělaný na generátor, který tvůj tým zvládne sám. Vždy v rámci stylu, bez tebe u každého kroku.', who: 'galerie / festivaly' },
        { no: '02', nm: 'Plot Calculator',    what: 'Parametrický stage plot a rider. Soubor zůstává editovatelný. Konec JPG, který nikdy přesně neseděl.', who: 'kapely na turné / zvuk' },
        { no: '03', nm: 'pose-to-OSC',        what: 'Tvoje tělo do OSC, v prohlížeči, bez složitého nastavení. Utilita, jakou si nová média předávají.', who: 'VJ / instalace' },
      ],
    },
    order: {
      ...
      cta1: 'Začít nástroj', cta2: 'Umělecké studio',
    },
